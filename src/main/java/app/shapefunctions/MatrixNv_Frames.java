/*
 * Esta classe fornece as funções de forma de elementos finitos de barra
 ...
 */
public class MatrixNv_Frames {

    /**
     * Este método fornece a matriz Nv de um elemento do tipo barra
     *
