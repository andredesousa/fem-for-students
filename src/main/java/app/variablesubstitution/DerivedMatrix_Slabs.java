 ...
 * Os métodos requerem as coordenadas r, s e o número de nós do elemento finito
...
public class DerivedMatrix_Slabs {
     ...
     * @return
     */
    public static double[][] derivedMatrix_ReissnerMindlin(double r, double s, double a, double b, int nodes) {
        double[][] matrixJ;
     ...
     * @return
     */
    public static double[][] derivedMatrix_Kirchhoff(double r, double s, double a, double b, int nodes) {
        double[][] matrixJ;
