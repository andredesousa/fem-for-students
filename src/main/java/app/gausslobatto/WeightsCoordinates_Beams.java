 ...
 * A segunda coluna recebe as coordenadas associadas a cada ponto de Gauss
 */
 ...
 */
public class WeightsCoordinates_Beams {
     ...
     * @return
     */
    public static double[][] weightsCoordinates_EulerBernoulli(double L, int points) {
        double[][] matrixWC;
     ...
     * @return
     */
    public static double[][] weightsCoordinates_Timoshenko(double L, int points) {
        double[][] matrixWC;
