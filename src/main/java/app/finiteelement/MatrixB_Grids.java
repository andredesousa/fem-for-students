/*
 * Esta classe fornece a matriz B de um elemento do tipo grelha
...
public class MatrixB_Grids {
    ...
    /**
     * Este método fornece a matriz B de um elemento do tipo grelha
     *
     ...
     * @return
     */
    public static double[][] matrixB_Grids(double x, double L, int nodes) {
        double[][] matrixB;
        ...
        if (L != 0 && nodes > 1) {
            if (nodes == 2) {
                ...
                matrixB[1][0] = -12 * x / (L * L * L);
                matrixB[1][1] = 0;
                matrixB[1][2] = 1 / L - 6 * x / (L * L);
                matrixB[1][3] = 12 * x / (L * L * L);
                matrixB[1][4] = 0;
